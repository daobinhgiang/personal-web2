                  ...
                  {milestone.company ? (
                    <>
                      ...
                      {milestone.images ? (
                        ...
                        <div className={`mt-4 ${milestone.image === "/timeline/harvard-hackathon.jpg" || milestone.image === "/timeline/peter-steinberger.jpg" ? "w-1/4" : "w-1/2"}`}>
                    ...
                    <>
                      ...
                      {milestone.images ? (
                        <div className="mt-3 flex gap-2 w-full" style={{ height: "clamp(150px, 25vh, 300px)" }}>
                          {milestone.images.map((img, i) => (
                            <img key={i} src={img} alt={`${milestone.title} ${i + 1}`} className="rounded-lg shadow-lg h-full min-w-0 flex-1 object-cover" />
                          ))}
                        </div>
